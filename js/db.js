const DB = {
    ...
    2: {
        question: '看圖組字',
        hint: '打一初春開花植物（2字）',
        moreHints: ['觀察圖中元素', '以一字描述一元素', '組合所有元素成二字答案'],
    ...
    19: {
        ...
        choices: [
            ...
            },
            {
                answer: '1，2，4',
                correct: true,
                notes: '第１行第1句：蘇味道《正月十五夜》。第１行第2句及第１行１，２句：歐陽修《生查子·元夕》。第４行：辛棄疾《青玉案·元夕》。第３行，第１句改崔灝《黃鶴樓》日暮鄉關何處是，第２句出自崔護《題都城南莊》'
            },
            {
                answer: '以上皆非',
            }
    ...
    46: {
        ...
        choices: [
            {
                answer: ['穀雨', '谷雨'],
                notes: '杜鵑別名布穀。王維《送梓州李使君》：万壑樹參天，千山響杜鵑，山中一夜雨，樹杪百重泉'
            }
        ]
    },
    47: {
    ...
    56: {
        ...
        choices: [
            {
                answer: '寒露',
                notes: '紹興八年，高宗問莆仙眾進士“卿土何奇？”，榜眼陳俊卿之答。貧寒盡露'
            }
        ]
    },
    57: {
    ...
    117: {
        question: '猜一種食物（不是韓國泡菜）',
        imageId: 'kimchi.jpg',
        moreHints: ['植物', '時常炒得脆脆的吃', '或配著臭豆腐吃'],
        choices: [
            {
                answer: ['高麗菜', '高丽菜'],
            },
...
*/
const db2026 = [
    69,116,117,79,81,82,83,114,80,85,86,87,88,89,90,115,100,101,102,103,104,105,106,107,108,109,110,111,70,77,78,75,72,73,71,74,76
];
